...
# line for cron jobs
# cd /home/ubuntu/work/2022_03_17_music_app_remote && stdbuf -oL -eL /usr/bin/python3 ./online_check.py >> /home/ubuntu/work/2022_03_17_music_app_remote/responses_logs/cron_logs/`date +\%Y-\%m-\%d-\%H:\%M`-online_check-cron.log 2>&1